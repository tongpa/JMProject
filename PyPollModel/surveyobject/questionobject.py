...
class QuestionObject(object):
    ...
    def __init__(self, id_question_type=None, image_upload=None, id_question=None,id_question_group=None, id_question_project=None, question=None,
        ...
        self.question = Question(id_question = self.id_question, id_question_type= self.id_question_type,id_question_project= self.id_question_project,id_question_group= self.id_question_group, 
